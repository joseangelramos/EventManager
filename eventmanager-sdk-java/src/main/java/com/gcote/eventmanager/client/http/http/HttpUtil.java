...
package com.gcote.eventmanager.client.http.http;
...
/**
 * Utilerias para enviar peticiones HTTP
 */
public class HttpUtil {
    ...
    public static void post(CloseableHttpClient client,
        ...
        Preconditions.checkState(client != null, "cliente no puede ser nulo");
        Preconditions.checkState(StringUtils.isNotBlank(uri), "uri no puede ser nulo");
        Preconditions.checkState(requestParam != null, "requestParam no puede ser nulo");
        Preconditions.checkState(responseHandler != null, "responseHandler no puede ser nulo");
        Preconditions.checkState(requestParam.getHttpMethod() == HttpMethod.POST, "requestParam para httpMethod invalido");
    ...
    public static void get(CloseableHttpClient client,
                           ...
                           ResponseHandler<String> responseHandler) throws Exception {
        Preconditions.checkState(client != null, "cliente no puede ser nulo");
        Preconditions.checkState(StringUtils.isNotBlank(uri), "uri no puedes ser nulo");
        Preconditions.checkState(requestParam != null, "requestParam no puede ser nulo");
        Preconditions.checkState(requestParam.getHttpMethod() == HttpMethod.GET, "requestParam para httpMethod invalido");
