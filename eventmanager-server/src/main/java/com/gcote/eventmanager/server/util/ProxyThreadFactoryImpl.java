...
public class ProxyThreadFactoryImpl implements ThreadFactory {
    private final AtomicLong threadIndex = new AtomicLong(0);
    private final String threadNamePrefix;
    private Boolean isDaemonSpecified = null;

    public ProxyThreadFactoryImpl(final String threadNamePrefix) {
        this.threadNamePrefix = threadNamePrefix;
    }

    public ProxyThreadFactoryImpl(final String threadNamePrefix, final boolean isDaemonSpecified) {
        this.threadNamePrefix = threadNamePrefix;
